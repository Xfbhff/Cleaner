#ifndef __MY_LCD_SPI_TOUCH_H
#define __MY_LCD_SPI_TOUCH_H
...
//与触摸屏芯片连接引脚
#define TOUCH_CLK       ReadPin(B,7)
#define TOUCH_MISO      ReadPin(B,12)
#define TOUCH_CS2       WritePin(B,14)
#define Penirq          ReadPin(B,15)

static const MyPinDef Pins_LCD_Touch[] = {PB12,PB14,PB15};

#define LCD_PEN_READ    Penirq//INT
#define LCD_DOUT_READ   TOUCH_MISO//MISO
...
typedef struct
{
    ...
    u16 y;
    u8  sta;//笔的状态 //b7:按下1/松开0;  //b6:0,没有按键按下;1,有按键按下.
////////////////////////触摸屏校准参数/////////////////////////
    float xfac;
    float yfac;
    short xoff;
